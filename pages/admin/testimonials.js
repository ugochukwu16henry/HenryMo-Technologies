...
export default function TestimonialsList() {
  ...
  const handleToggleFeatured = async (testimonial) => {
    const loadingToast = toast.loading(
      testimonial.featured ? "Unfeaturing..." : "Featuring..."
    );
    ...
    try {
      ...
      setTestimonials(
        testimonials.map((t) => (t.id === testimonial.id ? response.data : t))
      );
      toast.success(
        `Testimonial ${
          testimonial.featured ? "unfeatured" : "featured"
        } successfully`,
        { id: loadingToast }
      );
    } catch (err) {
        ...
        <ConfirmModal
          ...
          message={
            deleteModal.testimonial
              ? `Are you sure you want to delete the testimonial from "${deleteModal.testimonial.clientName}"? This action cannot be undone.`
              : ""
          }
          confirmText="Delete"
          cancelText="Cancel"

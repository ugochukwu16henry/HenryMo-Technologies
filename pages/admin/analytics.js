          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center gap-4 flex-1 min-w-0">
                <Link
                  href="/admin"
                  className="text-xl font-semibold text-gray-900 hover:text-[#007BFF] whitespace-nowrap"
                >
                  HenryMo Admin
                </Link>
                <div className="flex gap-2 overflow-x-auto scrollbar-hide">
                  <Link
                    href="/admin/pages"
                    className="px-3 py-2 rounded-md text-sm font-medium text-gray-600 hover:text-gray-900 whitespace-nowrap"
                  >
                    Pages
                  </Link>
                  <Link
                  ...
                  <Link
                    ...
                    className="px-3 py-2 rounded-md text-sm font-medium text-[#007BFF] bg-blue-50 whitespace-nowrap"
                  >
                    Analytics
                  </Link>
                  <Link

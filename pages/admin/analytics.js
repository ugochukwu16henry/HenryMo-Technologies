      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-gray-500 text-sm font-medium mb-2">Total Page Views</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-sm text-gray-500 mt-2">Estimated based on visitor IDs</p>
          </div>
          
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-gray-500 text-sm font-medium mb-2">Pages Tracked</h3>
            <p className="text-3xl font-bold text-gray-900">{stats?.pagesTracked || 0}</p>
            <p className="text-sm text-gray-500 mt-2">Different pages visited</p>
          </div>
          
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-gray-500 text-sm font-medium mb-2">Avg. Views/Day</h3>
            <p className="text-3xl font-bold text-gray-900">
              {stats?.averageViewsPerDay ? Math.round(stats.averageViewsPerDay) : 0}
            </p>
            <p className="text-sm text-gray-500 mt-2">Over last {dateRange} days</p>
          </div>
        </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {stats?.recentViews?.map((view, idx) => (
                  <tr key={idx}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {view.userAgent 
                        ? (view.userAgent.includes('Mobile') ? 'Mobile' : 'Desktop')
                        : 'Unknown'}
                    </td>
                  </tr>
                )) || (
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <h3 className="font-semibold text-blue-900 mb-2">💡 Google Analytics Integration</h3>
          <p className="text-blue-800 text-sm mb-2">
            For more detailed analytics (geographic data, demographics, user flow, etc.), 
            configure Google Analytics:
          </p>
          <ol className="list-decimal list-inside text-blue-800 text-sm space-y-1">
            <li>Get your Measurement ID from <a href="https://analytics.google.com" target="_blank" rel="noopener noreferrer" className="underline">Google Analytics</a></li>
            <li>Add it as <code className="bg-blue-100 px-1 rounded">NEXT_PUBLIC_GA_ID</code> in Railway environment variables</li>

  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Terms of Service for HenryMo Technologies - Rules and guidelines for using our services." />
      </Head>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 md:p-12 space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  By accessing or using the services provided by HenryMo Technologies, you agree to be 
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  HenryMo Technologies provides digital solutions including but not limited to:
                </p>
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  All content, designs, code, and materials created by HenryMo Technologies remain our 
                  intellectual property until full payment is received. Upon completion of payment, 
                  ownership of deliverables will transfer to the client as specified in individual 
                  project agreements.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Project timelines are estimates and may vary based on project scope and complexity. 
                  We will communicate any changes to the timeline promptly. Delays caused by client 
                  feedback or changes may extend the project deadline.
                </p>
              </div>

              {/* Revisions */}
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">7. Revisions and Changes</h2>
                <p className="text-gray-600 leading-relaxed">
                  Each project includes a specified number of revision rounds as outlined in the 
                  project agreement. Additional revisions or scope changes may incur extra charges.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  HenryMo Technologies shall not be liable for any indirect, incidental, special, 
              ...
              {/* Warranty Disclaimer */}
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">9. Warranty Disclaimer</h2>
                <p className="text-gray-600 leading-relaxed">
                  Our services are provided &quot;as is&quot; without warranties of any kind, either express 
                  or implied. We do not guarantee that our services will be uninterrupted, error-free, 
              ...
              {/* Confidentiality */}
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">11. Confidentiality</h2>
                <p className="text-gray-600 leading-relaxed">
